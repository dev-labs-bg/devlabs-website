...
$(document).ready(function() {
    ...
    console.message()
        ...
        .group()
            ...
            .line()
            .text('PS: If you want to have a conversation with us, we will be eager to discuss the opportunity to become part of our team. Write to us at hello@devlabs.bg and mention the secret reference: TCG')
        .groupEnd()
    .print();
